#include "assets/AssetBinaryIO.h"
#include <fstream>

namespace fresh::asset {

bool AssetBinaryIO::writeGraph(const std::string& path, const vm::Bytecode& prog) {
...
bool AssetBinaryIO::readGraph(const std::string& path, vm::Bytecode& prog) {
